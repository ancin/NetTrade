...
import com.etrade.framework.core.exception.ExceptionLogger;
import com.etrade.framework.core.web.json.HibernateAwareObjectMapper;
...
public class Jackson2LibHandler implements ContentTypeHandler {
    ...
    public static final String                                 DEFAULT_JSON_FILTER_NAME          = "etradeFilter";

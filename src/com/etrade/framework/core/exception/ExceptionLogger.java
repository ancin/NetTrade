...
import com.etrade.framework.core.web.interceptor.ExtTokenInterceptor;

public class ExceptionLogger {

    private static final Integer PAD_SIZE = 30;

    private static final Logger  logger   = LoggerFactory.getLogger("com.etrade.errors");

    public static String logForHttpRequest(Throwable e, HttpServletRequest request) {

        //异常情况移除用于控制重复提交的Token记录，使得用户可以再次提交
        //see *.core.web.interceptor.ExtTokenInterceptor
        ...
        if (e != null) {
            ...
            if (e instanceof com.etrade.framework.core.exception.DuplicateTokenException) {
                errorMessage = "请勿重复提交表单";
                skipLog = true;
            } else if (e instanceof ValidationException) {
                errorMessage = e.getMessage();
                skipLog = true;
            } else if (e instanceof com.etrade.framework.core.exception.BaseRuntimeException) {
